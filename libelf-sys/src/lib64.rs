...
#![allow(bad_style)]
use ::libc::{gid_t, mode_t, size_t, time_t, uid_t};
...
pub const ELF_NOTE_FDO: &[u8; 4usize] = b"FDO\0";
...
pub mod Elf_Type {
    ...
    pub const ELF_T_NHDR8: Type = 26;
    pub const ELF_T_NUM: Type = 27;
}
#[repr(C)]
pub struct Elf_Data {
...
fn bindgen_test_layout_Elf_Data() {
    const UNINIT: ::std::mem::MaybeUninit<Elf_Data> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).d_buf) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Data),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).d_size) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Data),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).d_align) as usize - ptr as usize },
        32usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Data),
...
fn bindgen_test_layout_Elf_Arhdr() {
    const UNINIT: ::std::mem::MaybeUninit<Elf_Arhdr> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).ar_rawname) as usize - ptr as usize },
        40usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Arhdr),
...
fn bindgen_test_layout_Elf_Arsym() {
    const UNINIT: ::std::mem::MaybeUninit<Elf_Arsym> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).as_name) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Arsym),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).as_off) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Arsym),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).as_hash) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(Elf_Arsym),
...
extern "C" {
    pub fn elf_memory(__image: *mut ::libc::c_char, __size: size_t) -> *mut Elf;
}
extern "C" {
...
extern "C" {
    pub fn elf_getident(__elf: *mut Elf, __nbytes: *mut size_t) -> *mut ::libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn elf_getphdrnum(__elf: *mut Elf, __dst: *mut size_t) -> ::libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn elf_getshdrnum(__elf: *mut Elf, __dst: *mut size_t) -> ::libc::c_int;
}
extern "C" {
    pub fn elf_getshnum(__elf: *mut Elf, __dst: *mut size_t) -> ::libc::c_int;
}
extern "C" {
    pub fn elf_getshdrstrndx(__elf: *mut Elf, __dst: *mut size_t) -> ::libc::c_int;
}
extern "C" {
    pub fn elf_getshstrndx(__elf: *mut Elf, __dst: *mut size_t) -> ::libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn elf_strptr(__elf: *mut Elf, __index: size_t, __offset: size_t) -> *mut ::libc::c_char;
}
extern "C" {
...
extern "C" {
    pub fn elf_rawfile(__elf: *mut Elf, __nbytes: *mut size_t) -> *mut ::libc::c_char;
}
extern "C" {
    pub fn elf32_fsize(
        __type: Elf_Type::Type,
...
extern "C" {
    pub fn gelf_newphdr(__elf: *mut Elf, __phnum: size_t) -> *mut ::libc::c_void;
}
extern "C" {
