...
impl<'dw> Attribute<'dw> {
    ...
    pub fn get_value(&self) -> Result<AttributeValue<'dw>> {
        ...
        let value = match self.form() {
            ...
            ffi::DW_FORM_flag_present | ffi::DW_FORM_flag => V::Bool(self.get_bool()?),
...
mod tests {
    ...
    fn attr_size() {
        use std::mem::size_of;
        assert_eq!(
            size_of::<crate::Attribute<'static>>(),
    ...
    fn attr_align() {
        ...
        assert_eq!(
            align_of::<crate::Attribute<'static>>(),
