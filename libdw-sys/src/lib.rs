...
pub const DWARF_GETMACROS_START: ::std::os::raw::c_longlong =
    -9223372036854775808;
pub const DW_AT_subscr_data: ::std::os::raw::c_uint = 10;
pub const DW_AT_element_list: ::std::os::raw::c_uint = 15;
pub const DW_AT_member: ::std::os::raw::c_uint = 20;
...
extern "C" {
    pub fn dwarf_default_lower_bound(lang: ::std::os::raw::c_int,
...
pub type _bindgen_ty_29 = ::std::os::raw::c_ulong;
